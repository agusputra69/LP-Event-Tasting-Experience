                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <a
                      ...
                      className="mt-6 flex items-center justify-center gap-2 rounded-full bg-[#a0505d]/85 py-2.5 text-xs font-semibold text-white transition-all hover:bg-[#a0505d] hover:scale-[1.02] active:scale-[0.98] w-full"
                    >
                      Follow on <LinkedInIcon className="size-3.5 fill-white text-white" />
                    </a>
                  </div>
                </article>
              ))}
